...
import re
import io
import requests # Logoyu internetten çekmek için
...
# =============================================================================
# 2. YARDIMCI FONKSİYONLAR (ORİJİNAL)
# =============================================================================
...
def hesapla_ve_analiz_et(stok_adi, adet):
    ...
    # --- PRAG İÇİN ÖZEL AYAR (ORİJİNAL KODDAN) ---
...
# =============================================================================
# PDF FONKSİYONLARI (GÜNCELLENMİŞ VERSİYONLAR)
# =============================================================================

# --- 1. YENİ TASARIMLI TERMAL ETİKET (CANVAS İLE) ---
...
# --- 2. GÜNCELLENMİŞ KARGO FİŞİ (ADET SÜTUNU + LOGO + SİYAH DESİ) ---
def create_cargo_pdf(proje_toplam_desi, toplam_parca, musteri_bilgileri, ham_tablo_verisi):
    ...
    gonderen_info = [Paragraph("<b>GONDEREN FIRMA:</b>", style_normal), Paragraph("NIXRAD / KARPAN DIZAYN A.S.", ParagraphStyle('h', fontSize=14, fontName='Helvetica-Bold', textColor=colors.darkred)), Paragraph("Yeni Cami OSB Mah. 3.Cad. No:1 Kavak/SAMSUN Tel: 0262 658 11 58", style_normal)]
    ...
    # Alıcı Bilgisi (Orijinal Tasarım)
    ...
    t_sum = Table(summary_data, colWidths=[9.5*cm, 9.5*cm], style=TableStyle([
        ...
        ('TEXTCOLOR', (1,0), (1,0), colors.black), # SİYAH YAPILDI
